...
export default function GiftShopsScreen() {
  ...
  const getFilteredShops = () => {
    const activeList = activeTab === 'all'
      ? shops
      : shops.filter(shop => user && shop.email === user.email);

    return activeList.filter((shop) => {
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View>
              ...
              <View style={[styles.tabContainer, { backgroundColor: themeColors.surfaceElevated, borderColor: themeColors.border }]}>
                ...
                >
                  <Text
                    style={[
                      styles.tabText,
                      { color: activeTab === 'all' ? THEME_ACCENT : themeColors.textSecondary },
                    ]}
                  >
                    All Shops
                  </Text>
                ...
                >
                  <Text
                    style={[
                      styles.tabText,
                      { color: activeTab === 'my' ? THEME_ACCENT : themeColors.textSecondary },
                    ]}
                  >
                    My Shops
                  </Text>
              ...
              {/* Featured Section */}
              {featuredShops.length > 0 && activeTab === 'all' && (
              ...
              <View style={[styles.sectionHeaderRow, { marginTop: 12, marginBottom: 8 }]}>
                <Text style={[styles.sectionTitle, { color: themeColors.text }]}>
                  {activeTab === 'all' ? 'All Gift Shops' : 'My Registered Shops'}
                </Text>
              </View>
            </View>
          }
